  ...
  return (
    <section className="login">
      <form className="login__form" onSubmit={login}>
        ...
        <div className="login__password">
          ...
          <input
            ...
            onBlur={e => inputOnblur(e, 'password')}
          />
        </div>
      ...
      <div className="social">
        <p>간편하게 로그인해보세요</p>
        <button type="button" className="login__button mb-1" onClick={() => socialLogin('kakao')}>
          카카오 로그인
        </button>
        <button type="button" className="login__button mb-1" onClick={() => socialLogin('google')}>
          구글 로그인
        </button>
